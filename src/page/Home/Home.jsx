...
const Home = () => {
    ...
    const [isBotRealease,setIsBotRelease] = React.useState(false)

    const handleBotRealease=()=>setIsBotRelease(!isBotRealease);
